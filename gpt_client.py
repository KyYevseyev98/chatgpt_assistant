...
async def tarot_reading_answer(
    *,
    ...
    prompt += (
        ...
        "   1–2 коротких предложения трактовки (чем больше карт, тем детальнее)\n"
        "5) Больше внимания итогам: в «Итоге» дай конкретику, вывод и направления. "
        "Итог по смыслу важнее и длиннее, чем блоки по картам.\n"
        "6) Если вопрос формата да/нет — в блоке «Главное» дай явный вероятностный ответ: «Скорее да» / «Скорее нет» и короткую причину.\n"
        "7) В конце НЕ давай шаги. Вместо шагов предложи 3 примера вопросов для следующего расклада.\n"
        ...
        f"11) Длина: 1 карта = коротко; 3 карты = подробно; 5–7 карт = очень подробно. (Сейчас карт: {n_cards}).\n"
        ...
        "🧭 <b>Итог</b> (4–6 предложений, конкретно)\n"
        "❓ <b>Примеры вопросов для следующего расклада</b> (3 пункта)\n"
    )
