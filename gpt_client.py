...
async def classify_tarot_intent(
    *,
    ...
    prompt = (
        "Ты — короткий и практичный определитель намерений для таролога. "
        ...
        "• Если деталей мало — intent_type=clarification_needed и предложи 1 естественный вопрос.\n"
        ...
        "  },\n"
        "  \"proposed_question\": \"одно уточнение\"\n"
        "}\n\n"
        f"CONTEXT:\n{ctx_block}\n\n"
        f"USER:\n{user_message}\n"
    )
