...
async def tarot_reading_answer(
    *,
    ...
    prompt += (
        ...
        "6) В блоке «Идеи»  с мягкой эмоцией закончи расклад и по дружески предложи 3 очень короткие идеи или примеры вопросов для следующего расклада , чтобы человек захотел продолжить диалог.\n"
        ...
        f"10) Длина: 1 карта = коротко; 2-7 карт = немного подробнее. (Сейчас карт: {n_cards}).\n"
        "11) Если в вопросе есть даты/возраст/сроки — используй их как основу для нумерологии/астрологии в толковании.\n"
        "\nФормат ответа:\n"
