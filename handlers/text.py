...
def start_text_tarot() -> str:
    return (
        "✨ Я — Астра. Профессиональный ИИ таролог, который даёт понятные и глубокие расклады. "
        "Со мной можно общаться как с настоящим человеком.\n\n"
        "Я помогу увидеть:\n"
        "❤️ что чувствует человек и к чему всё идёт\n"
        "🔮 перспективы ситуации или отношений\n"
        "🧭 возможные решения и направления\n\n"
        "Я делаю:\n"
        "🃏 реальные карты Rider–Waite\n"
        "🧠 подробную трактовку без общих фраз\n"
        "🎯 разбор именно вашей ситуации\n\n"
        "Примеры вопросов:\n"
        "— Что он ко мне чувствует?\n"
        "— Стоит ли продолжать отношения?\n"
        "— Что меня ждёт в работе?\n\n"
